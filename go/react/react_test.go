...
// The value of a compute 1 cell is determined by the value of the updates.
...
// The value of a compute 2 cell is determined by the value of the updates.
...
// Callbacks should not be called if updates change in such a way
